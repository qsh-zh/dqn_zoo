...
# baseline
python3 -m dqn_zoo.dqn.run_atari --num_train_frames=100000 --num_iterations=2000 --num_eval_frames=200000 --eval_freq=10 --wandb=true --name=baseline
```
...
# baseline
python3 -m dqn_zoo.prioritized.run_atari --num_train_frames=100000 --num_iterations=2000 --num_eval_frames=200000 --eval_freq=10 --wandb=true --name=baseline
```
...
python3 -m dqn_zoo.exp.run_atari --num_train_frames=100000 --num_iterations=2000 --num_eval_frames=200000 --eval_freq=10 --wandb=true --name=baseline
```